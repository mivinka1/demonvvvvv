...
@Client.on_message(filters.command(["start", "start@demonplayer_bot"]) & filters.private & ~filters.channel)
async def start(_, message: Message):
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            ...
            InlineKeyboardButton("💬 Group", url="https://t.me/botdemonsupport"),
            InlineKeyboardButton("Commands 🛠", url="https://telegra.ph/file/e3f72ccaaaf974c285aa8.jpg")
            ]]
        ),
...
async def gstart(_, message: Message):
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [[
            InlineKeyboardButton(text="🎙️ Support Group 🎙️", url="https://t.me/botdemonsupport")
            ]]
        )
    )


@Client.on_message(filters.command(["cmdlist", "start@demonplayer_bot"]) & filters.private & ~filters.channel)
